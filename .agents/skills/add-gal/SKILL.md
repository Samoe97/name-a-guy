---
name: add-gal
description: Add a gal to the gals.json list with all relevant information.
---

<!-- Tip: Use /create-skill in chat to generate content with agent assistance -->

Using the JSON schema found in gals.json, add the requested person or people to the list.

Each person should have at least 6 identifying categories. The first category should be their profession.
...
Append this new person to the end of the gals.json list.