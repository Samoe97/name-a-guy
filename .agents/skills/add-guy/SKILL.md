---
name: add-guy
description: Add a guy to the guys.json list with all relevant information.
---

<!-- Tip: Use /create-skill in chat to generate content with agent assistance -->

Using the JSON schema found in guys.json, add the requested person or people to the list.
